        ...
        {!loading &&
          bookings?.map((booking, index) => (
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6 border border-[var(--color-borderColor)] rounded-lg mt-5 first:mt-12 shadow-sm hover:shadow-md transition-all"
            >
              {/* Car Image & Info */}
              ...
              <div className="md:col-span-1 flex flex-col justify-between gap-6">
                <div className="text-sm text-right">
                  ...
                  <p>Booked on {formatToIndianDate(booking?.createdAt)}</p>
                </div>
              </div>
            </motion.div>
          ))}
